...
function wp_bootstrap_starter_scripts() {
    ...
    //styles for gallery
    wp_enqueue_style( 'baguetteBox', get_template_directory_uri() . '/inc/assets/css/baguetteBox.min.css' );
    ...
    wp_enqueue_script('baguetteBox-js', get_template_directory_uri() . '/inc/assets/js/baguetteBox.min.js', array() );
    wp_enqueue_script('slickjs', get_template_directory_uri() . '/inc/assets/js/slick.js', array() );
    wp_enqueue_script('customjs', get_template_directory_uri() . '/inc/assets/js/custom.js', array() );
